...
const uint16_t WAKE_MASTER_EVERY = 5;	// Every XX seconds we wake up ESP master for it to poll our data
const uint16_t MEASUREMENT_EVERY = 3;		// How often we take a measurement from our sensors
