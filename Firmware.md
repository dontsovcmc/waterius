...
> **Зачем перепрошивать attiny.** [Тревоги](Alarms.md) — экспериментальная функция — считает
> attiny, и для них нужна её прошивка версии 41 или новее. По воздуху attiny не обновляется:
> ЕСП можно обновить по Wi-Fi, а attiny — только программатором, по инструкции ниже. Типы
> входа «датчик протечки» и «Электронный (+)» — тоже её версии, 41 и 39 соответственно.
