...
#define KEY_LEN 33
#define HOSTNAME_LEN 31

#define EMAIL_LEN 31
#define EMAIL_TITLE_LEN 63
#define EMAIL_TEMPLATE_LEN 199
...
struct Settings
{
	...
	*/
	...
	SEND_TCP: не используется	
	*/
	char     email_title[EMAIL_TITLE_LEN+1];

	/*
	SEND_BLYNK: Шаблон эл. письма. {V0}-{V4} заменяются на данные 
	SEND_TCP: не используется	
	*/
	char     email_template[EMAIL_TEMPLATE_LEN+1];
