...
3. Припять черный разъем PBD-8 с небольшим количеством олова, чтобы можно было откусить контакты, выступающие больше чем на 0.5-1мм от платы.
...
10. Подготовьте корпус Вотериуса и установите в него плату.
