...
#
# Две минуты - не терпение, а цена ошибки: ожидание при живой плате стоит ноль,
# а несостоявшийся подъём стоит всего прогона. Замер 24 сентября: отлучка на
# старте длилась дольше полминуты и снесла весь набор за 59 секунд - 132 теста
# не начались.
METF_WAIT_S = 120.0
METF_POLL_S = 3.0
