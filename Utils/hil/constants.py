...
# (Attiny85/src/main.cpp: "кнопка на i2c и 2 пине ESP"), и нажатие вплотную к
# снятию питания до attiny не доходит: стенд жал впустую и ждал своего сеанса
# до таймаута. Само число - со слов владельца стенда: в прошивке такой
# константы нет, вывести её из исходников не из чего
WAKE_SETTLE_S = 2.5
