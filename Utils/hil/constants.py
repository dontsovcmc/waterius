...
# этого стенда), но сеанс с применением настроек отправляет данные дважды и
# может добавить конфиги автообнаружения - тридцати секунд ему не хватило.
# Полсотни - со слов владельца стенда: дольше честный сеанс не идёт
SESSION_TAIL_S = 50.0
