...
static const char PARAM_STATE1GOOD[] PROGMEM = "state1good";
static const char PARAM_STATE1BAD[] PROGMEM = "state1bad";
static const char TETX_CONNECTED[] PROGMEM = "Подключён";
static const char TEXT_EMPTY[] PROGMEM = "";
static const char PARAM_ELAPSED[] PROGMEM = "elapsed";
static const char PARAM_FACTORCOLDFEEDBACK[] PROGMEM = "factor_cold_feedback";
static const char PARAM_FACTORHOTFEEDBACK[] PROGMEM = "factor_hot_feedback";
static const char PARAM_FAIL[] PROGMEM = "fail";
