...
bool connect_and_subscribe_mqtt(Settings &sett, const AttinyData &data, const CalculatedData &cdata, DynamicJsonDocument &json_data)
{
 ...
 */
bool send_mqtt(Settings &sett, const AttinyData &data, const CalculatedData &cdata, DynamicJsonDocument &json_data)
{
