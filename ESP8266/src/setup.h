...
0.11.7 - 2023.08.09 - dontsovcmc
                      1. не дублируются wi-fi сети
                      2. возможно устранена ошибка подключения к SSID с пробелом
                      3. Теперь ПРОШИВКА ATINY ДЛЯ КОРОТКИХ ИМПУЛЬСОВ!
                      4. Теперь только ATiny85, в 45ю не влезает код
                      5. Добавил разное имя датчиков для HomeAssistant
