...
0.10.6 - 2022.02.18 - neitri, dontsovcmc
                      ...
                      2. attiny версия 24
                      3. перезарузка ESP после настройки для передачи данных
                      4. параметры: 
                      ...
                      5. флаг завершения настройки (подключения к роутеру)
                      6. чтение напряжения ESP
                      7. период отправки 24ч (корректируется по NTP. точность +-1 мин)
