...
0.10.6 - 2022.02.18 - neitri, dontsovcmc
                      ...
                      2. перезарузка ESP после настройки для передачи данных
                      3. флаг нажатия кнопки для передачи данных
                      4. чтение напряжения ESP
                      5. период отправки 24ч корректируется по NTP
