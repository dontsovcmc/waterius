 ...
 *
 * @return true  если разница измеренных напряжений больше 50 мВ и напряжение меньше 2.9В, (батарейка разрядилась)
 * @return false  если разница измеренных напряжений меньше 50 мВ и напряжение больше 2.9В, (батарейка заряжена)
 */
bool Voltage::low_voltage()
{
    // если просдка больше 50 мВ и напряжение меньше 2.9В
