...
/*
    Флаги в Header.flags. Бит 0 занят, биты 1-7 про запас: следующий флаг
    не потребует ни лишнего байта, ни новой версии протокола.

    ESP_POWERED_LONG: питание ЕСП подано дольше ESP_POWERED_LONG_MSEC.
*/
...
struct Header
{
    ...
    */
    ...
    /*
    Флаги состояния, см. HEADER_FLAG_*. Байт лежал резервом "для
    совместимости с 0.10.0" и у старых прошивок всегда нулевой, поэтому ЕСП
    отличает его по версии прошивки.
    */
    uint8_t flags;
