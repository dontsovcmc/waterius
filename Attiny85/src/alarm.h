...
struct AlarmDetector
{
    ...
    */
    void on_type_changed()
    {
        ...
        // Ритм прежнего входа к новому отношения не имеет. ticks не трогаем:
        // это время с последнего импульса, и обнулить его значит начать отсчёт
        // от момента настройки - первый же импульс окажется "короче порога" и
        // поднимет тревогу расхода на пустом месте.
        prev_gap = 0;
        run_min = 0;
    }
