...
0. Записать видео установки/настройки Ватериуса (можно сразу в [FB](https://www.facebook.com/waterius), [VK](https://vk.com/waterius1))
1. Туториал как спаять, скомпилировать и прошить Ватериус (Arduino IDE). Просто текст и фото, я отредактирую.
...
- На [Attiny84](https://github.com/dontsovcmc/waterius/issues/41#issuecomment-439402464) делается тут [Waterius-Attiny84-ESP12F](https://github.com/badenbaden/Waterius-Attiny84-ESP12F)
