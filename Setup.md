...
- Для настройки: найдите телефоном Wi-Fi точку доступа Waterius_0.8.2, подключитесь к ней.
...
1. SSID и password надо вводить каждый раз при входе в режим настройки!
