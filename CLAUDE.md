...
Ready-to-run procedure — ports, model detection, build artifact names, avrdude
and esptool paths, fuses, and how success is proven: **[docs/flashing.md](docs/flashing.md)**.
